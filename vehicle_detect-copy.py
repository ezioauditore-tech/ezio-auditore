            ...
            if det is not None and len(det):
                ...
                if len(outputs) > 0:
                    ...
                    if t_id != temp_track:
                        ...
                        number_plate = pytesseract.image_to_string(Image.fromarray(cropped_image))
                        print(t_id)
                        v_type=names[int(c)]
                        print(v_type)
                        print("vehicle info: ",number_plate)
                        Vehicle_info=str(t_id)+","+str(v_type)+","+str(number_plate)
                        print(Vehicle_info)
                        # cropped
